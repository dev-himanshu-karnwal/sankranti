    ...
    <div className="min-h-screen bg-surface-base flex flex-col font-['Poppins']">
      ...
      <main className="flex-1 flex flex-col items-center overflow-y-auto pb-6">
        ...
        <div className="relative w-full aspect-[4/3] flex items-center justify-center mt-2 max-w-[500px]">
          ...
          <img src="/images/dishes.png" alt="Curry Goat Bowl Image" className="relative z-10 w-[95%] h-auto object-contain drop-shadow-[0_15px_30px_rgba(0,0,0,0.12)] -translate-x-1" />
        </div>
        ...
        <div className="relative z-20 bg-surface-subtle w-[294px] h-[280px] mx-auto rounded-[29px] shadow-[0_4px_24px_rgba(0,0,0,0.04)] -mt-16 overflow-hidden">
          ...
          >
            ...
            <div className="w-1/3 h-full flex flex-col items-center justify-center p-6 text-center">
              <span className="text-[12px] text-text-primary font-normal leading-[150%] tracking-normal uppercase text-center mt-1">Sankranti Rewards</span>
              ...
              <div className="w-[180px] flex flex-col gap-[14px] mb-6">
                <Button variant="secondary" className="!py-[12px]">JOIN NOW</Button>
                <Button variant="primary" className="!py-[12px]">SIGN IN</Button>
              </div>
              
              <Link to="#" className="text-[12px] text-secondary font-medium leading-[150%] tracking-normal uppercase text-center hover:opacity-80 transition-opacity">
                How Rewards Works
              </Link>
            </div>
            ...
            <div className="w-1/3 h-full flex flex-col items-center justify-center p-6 text-center">
              ...
              <div className="w-[180px] mb-2 flex-shrink-0">
                <Button variant="primary" className="!py-[12px] uppercase text-[13px] font-bold tracking-wider w-full">
                  ORDER NOW
                </Button>
              </div>
            </div>
            ...
            <div className="w-1/3 h-full flex flex-col items-center justify-center p-6 text-center px-4">
              {/* Customer Name */}
              <span className="text-[12px] text-text-primary uppercase tracking-wide mb-1 font-medium">CUSTOMER NAME</span>
              
              {/* Points */}
              <div className="flex flex-col items-center mb-8 text-text-primary">
                <span className="text-[20px] mb-0.5 leading-tight">You've Got</span>
                <span className="text-[28px] font-bold leading-none tracking-tight">10 POINTS</span>
              </div>
              ...
              <div className="flex flex-col items-center text-secondary">
                <span className="text-[12px] font-bold uppercase tracking-wide">REWARDS EXCHANGE</span>
                <span className="text-[13px] font-medium mt-0.5">Redeem your points</span>
              </div>
            </div>
