  ...
  return (
    <div className="min-h-dvh bg-surface-base p-6 text-text-primary">
      ...
      <p className="text-text-secondary text-sm mb-6">
        Use the links below to quickly navigate through the application pages
        during development.
      </p>
      ...
      <div className="flex flex-col gap-3">
        {pages.map((page) => (
          ...
          >
            <Link to={page.path} className="flex-1 min-w-0 pr-4 block">
              <h2 className="text-[16px] font-semibold text-text-primary capitalize">
                {page.name}
              </h2>
