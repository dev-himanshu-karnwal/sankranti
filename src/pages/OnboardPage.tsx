    ...
    <div className="h-screen bg-surface-muted flex flex-col items-center justify-between">
      ...
      <div className="flex flex-col items-center justify-center gap-7">
        ...
        <div className="bg-surface-accent text-center flex flex-col items-center justify-center p-7 w-[90vw] max-w-[500px] relative rounded-[20px]">
          ...
          <h2 className="text-xl font-bold leading-none tracking-normal text-center">
            Taste and feel the Difference
          </h2>
          <p className="text-[12px] font-normal leading-[150%] text-center mb-6">
            Sankranti is about growth, <br />
            celebration, and eating great food together
          </p>
          ...
          <Link
            className="relative flex items-center text-[10px] text-secondary gap-1 after:absolute after:left-0 after:bottom-0 after:h-px after:w-0 after:bg-current after:transition-all after:duration-200 hover:after:w-full"
            to="#"
          >
            Continue as Guest
            <span className="h-[7px]">
              ...
              >
                <path
                  d="M3 2.49999C3 2.55811 2.97556 2.6163 2.92675 2.66067L0.426763 4.93339C0.329076 5.0222 0.17089 5.0222 0.0732652 4.93339C-0.0243592 4.84459 -0.0244217 4.70078 0.0732653 4.61203L2.3965 2.49999L0.0732653 0.387947C-0.0244217 0.29914 -0.0244217 0.155334 0.0732653 0.0665836C0.170952 -0.0221663 0.329139 -0.022223 0.426763 0.0665836L2.92675 2.33931C2.97556 2.38368 3 2.44186 3 2.49999Z"
                  fill="#4B4448"
                />
              </svg>
            </span>
