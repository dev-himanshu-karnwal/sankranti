...
export default function MenuHeader({ onMenuToggle, onCartToggle }: MenuHeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between px-10 py-3 w-full bg-white shadow-sm z-50 sticky top-0">
      ...
      <nav className="flex items-center gap-8 justify-center flex-1">
        ...
        <Link to="/menu" className="text-[12px] font-bold text-primary tracking-wide leading-none">MENU</Link>
