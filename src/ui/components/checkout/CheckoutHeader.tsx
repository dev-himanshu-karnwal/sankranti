...
export default function CheckoutHeader({ onMenuToggle, onCartToggle }: CheckoutHeaderProps) {
  ...
  return (
    <header className="hidden md:flex items-center justify-between px-10 py-3 w-full bg-white shadow-sm z-50 sticky top-0">
      <div className="flex-1 flex items-center justify-start">
        <img src="/images/sankranti_indian_kitchen.png" alt="Sankranti Logo" className="w-[85px] h-auto object-contain cursor-pointer" onClick={() => navigate('/home')} />
      </div>
