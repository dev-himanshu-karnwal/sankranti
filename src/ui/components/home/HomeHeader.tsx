...
export default function HomeHeader({ onMenuToggle, onCartToggle }: HomeHeaderProps) {
  ...
  return (
    <>
      <div className="md:hidden"><PanelLayout isShowDeliveryOption={true} /></div>
      <header className="hidden md:flex items-center justify-between px-10 py-3 w-full bg-surface-subtle shadow-sm z-50">
        ...
        <nav className="flex items-center gap-8 justify-center flex-shrink-0">
