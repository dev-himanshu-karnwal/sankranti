    ...
    <div className="flex flex-col items-center">
      <div className={containerClass}>
        <div className="flex h-full w-[300%] transition-transform duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] will-change-transform" style={{ transform: `translateX(-${currentSlide * (100 / 3)}%)` }}>
          ...
          {/* SLIDE 1 */}
          <div className={`w-1/3 h-full flex flex-col items-center justify-center ${slidePadding} text-center`}>
            <div className="flex-1 w-full flex items-center justify-center mb-4 md:mb-6 relative"><img src="/images/Bowl.png" alt="Curry Goat Bowl" className="w-[190px] md:w-[190px] h-auto object-contain drop-shadow-md" /></div>
            <div className="w-[180px] md:w-[200px] mb-2 flex-shrink-0"><Button variant="primary" onClick={() => navigate('/menu')} className={`!${buttonPadding} uppercase text-[13px] md:text-[14px] font-bold tracking-widest w-full`}>ORDER NOW</Button></div>
          </div>
          {/* SLIDE 2 */}
          <div className={`w-1/3 h-full flex flex-col items-center justify-center ${slidePadding} text-center`}>
            ...
            <div className="w-[180px] md:w-[200px] mb-8 flex-shrink-0"><Button variant="primary" onClick={() => navigate('/reward')} className={`!${buttonPadding} uppercase text-[13px] md:text-[14px] font-bold tracking-widest w-full`}>ABOUT REWARDS</Button></div>
